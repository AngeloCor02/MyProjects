...
////////////////////////////ACCESSORI/////////////////////////////////////
        ...
        Accessori accessorioPrincipale = new Accessori("",0, 0 , 0);

        Accessori[] accessorio = new Accessori[]{

            new Accessori("Amuleto della forza", 4, 0, 0),
...
////////////////PERSONAGGI////////////////////////////////////////////////////        
        ...
        Personaggi protagonista = new Personaggi("Cortiz", 25, 4, 2, 25, armaPrincipale, accessorioPrincipale);
...
//////////////////////////////////////////////////////////////////////////////////////////////
        ...
        gioco(protagonista,nemico, nemici, consumabili, armaPrincipale, arma, accessorio, accessorioPrincipale);  
    ...
    public static void gioco(Personaggi protagonista, Personaggi nemico, Personaggi[] nemici, Consumabili[] consumabili , Armi armaPrincipale, Armi[] arma, Accessori[] accessorio, Accessori accessorioPrincipale){
        ...
        System.out.println( ".....................................\r\n" + //
            ...
            switch (risp) {
                ...
                default :
                    ...
                    protagonista.avanza(protagonista,nemico, nemici, scan, consumabili, accessorio, accessorioPrincipale, armaPrincipale, arma);
    ...
    public static void inventario(Personaggi protagonista, Consumabili[] consumabili, Armi[] arma, Accessori[] accessorio,Scanner scan){
        ...
        for(int i=0;i < accessorio.length ;i++ ){
            ...
            if(accessorio[i].getquantita() != 0){
                ...
                System.out.println(accessorio[i].getNomeAccessorio() + " " + accessorio[i].getquantita());
